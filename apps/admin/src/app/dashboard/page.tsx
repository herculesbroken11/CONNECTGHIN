  ...
  return (
    ...
    >
      <div className="flex min-h-[calc(100vh-170px)] flex-col">
        ...
        <div className="mt-3 grid flex-1 gap-3 xl:grid-cols-[2fr_1fr]">
          <section className="admin-panel flex h-full flex-col p-4">
            ...
            <div className="mt-4 h-full min-h-[290px] rounded-xl border border-slate-800/80 bg-gradient-to-b from-emerald-500/5 to-transparent p-4">
          ...
          <div className="flex h-full flex-col gap-3">
            ...
            <section className="admin-panel flex-1 p-4">
