        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              ...
              'Add a photo and more details to finish setup.',
            ),
          ),
        );
        return;
      ...
      body: _loading
          ...
          : Form(
              ...
              child: ListView(
                ...
                children: [
                  Text(
                    'Tell other golfers who you are. You need at least '
                    '${UserMe.onboardingCompletionThreshold}% profile completion to continue.',
